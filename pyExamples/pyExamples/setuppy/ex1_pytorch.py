__doc__ = """
          This is an advanced example of a setup.py which has to combine
          cpp and CUDA libraries as part of its package installation.
          
          Note some lines has been disabled to allow importing it.
          
          There are some interesting functions present in the module:
          
          interesting functions
          ---------------------
          clean - uses the .gitignore file to remove all files that match
                  its pattern.
          """
